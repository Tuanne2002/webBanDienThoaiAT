...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logoo.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">TDAT Phone Store</a> - All rights reserved © 2021 - Designed by
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="top-row">
                            <div class="field-wrap">
                                ...
                                <input name="ho" type="text"  autocomplete="off" />
                            </div>
                            ...
                            <div class="field-wrap">
                                ...
                                <input name="ten" type="text"  autocomplete="off" />
                            </div>
                        </div> <!-- / ho ten -->
                        ...
                        <div class="field-wrap">
                            ...
                            <input name="newUser" type="text" autocomplete="off" />
                        </div> <!-- /user name -->
